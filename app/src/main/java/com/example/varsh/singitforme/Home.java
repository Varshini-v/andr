...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = FirebaseDatabase.getInstance().getReference().child("Users").child(mauth.getCurrentUser().getUid()).child("Shelf");
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                com.example.varsh.singitforme.Book newb=new com.example.varsh.singitforme.Book(title.getText().toString(),author.getText().toString(),genre.getText().toString());
                db.push().setValue(newb);
                Toast.makeText(Home.this,"Book Added to your Shelf",Toast.LENGTH_LONG).show();
                startActivity(new Intent(Home.this,Myshelf.class));
            }
        });
...
//        so=(Button)findViewById(R.id.button2);
        mauth=FirebaseAuth.getInstance();
